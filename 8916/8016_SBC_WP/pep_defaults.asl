            ...
            package()
            {
                ...
                package()
                {
                    ...
                    package()
                    {
                        ...
                        package()    
                        {   
                            "PPP_RESOURCE_ID_LDO15_A",   // Voltage Regulator ID
                            1,                           // Voltage Regulator type = LDO
                            1800000,                           // Voltage         : 1.8v in microvolts ( V  )
                            50000,                           // Peak Current    : 50mA in microamps  ( ip )
                            1,                           // SW Enable = Enable
                            0,                           // Pin Enable = None
                            1,                           // SW Power Mode = NPM
                    ...
                    package()
                    {
                        ...
                        package()    
                        { 
                            "PPP_RESOURCE_ID_LDO16_A",   // Voltage Regulator ID
                            1,                           // Voltage Regulator type = LDO
                            1800000,                           // Voltage         : 1.8v in microvolts ( V  )
                            50000,                           // Peak Current    : 50mA in microamps  ( ip )
                            1,                           // SW Enable = Disable
