...
// 
        ...
        //
        // Power Management IC (PMIC) Defines
        //
        // See pmicdefs.asl

        //
        // Battery Gauging and Charging Defines
        //
        // See pmicbatt.asl
       ...
       Device (PMAP) {
		...
		Device (PRTC) {
            ...
            // Get and Set Time use the following buffer 112 Bits / 14 bytes
            //
            // Buffer (){
            ...
            //{
            //    Name(BUFF, Buffer(18){})          // 18 bytes STAT(1), SIZE(1), Time(16)
            ...
            //    CreateField(BUFF, 16, 128, TME1) 	// Create the TIME Field - For the time
            //    Store(Arg0, TME1)            		// Store the time data passed in the TIME Field
