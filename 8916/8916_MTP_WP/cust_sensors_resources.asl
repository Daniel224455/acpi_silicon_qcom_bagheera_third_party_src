            ...
            Package()
            {
                ...
                package()
                {
                    ...
                    package()
                    {
                        ...
                        2850000,    // Voltage in micro volts
                        330,        // Peak current in microamps
            ...
            Package()
            {
                ...
                package()
                {
                    ...
                    package()
                    {
                        ...
                        1,          // Voltage Regulator type = LDO
                        2850000,    // Voltage in micro volts
                        3900,       // Peak current in microamps
                        1,          // force enable from software
                        0,          // disable pin control enable
                        1,          // power mode - Normal Power Mode
                        0,          // power mode pin control - disable
                ...
                Package() {"DELAY", package() { 150 }}, // 150 Milsec delay
            },
            Package() {"DSTATE", 0x1}, // D1 state
            Package() {"DSTATE", 0x2}, // D2 state
            Package()
            ...
            Package()
            {
                ...
                package()
                {
                    ...
                    package()
                    {
                        ...
                        1,          // Voltage Regulator type = LDO
                        2850000,    // Voltage in micro volts
                        2160,       // Peak current in microamps
                        1,          // force enable from software
                        0,          // disable pin control enable
                        1,          // power mode - Normal Power Mode
                        0,          // power mode pin control - disable
