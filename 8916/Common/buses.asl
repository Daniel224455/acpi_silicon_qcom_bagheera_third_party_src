...
Device (SPI1)
{
    ...
    Method (_CRS)
    {
        Name (RBUF, ResourceTemplate()
        {
            Memory32Fixed(ReadWrite, 0x078b5000, 0x00000800)
...
Device (I2C5)
{
    ...
    Method (_CRS, 0x0, NotSerialized) {
        ...
        {
            // QUP register address space
            Memory32Fixed (ReadWrite, 0x078B9000, 0x00000600)
    ...
    Name(BSRC, Package()
    {
        ...
        Package()
        {
            ...
            Package()
            {
                ...
                Package(){"PSTATE", 0, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 960000, 3}}},
                Package(){"PSTATE", 1, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 4800000, 3}}},
                Package(){"PSTATE", 2, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 9600000, 3}}},
                Package(){"PSTATE", 3, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 16000000, 3}}},
                Package(){"PSTATE", 4, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 19200000, 3}}},
                Package(){"PSTATE", 5, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 25000000, 3}}},
                Package(){"PSTATE", 6, Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 3, 50000000, 3}}},
            },
            ...
            Package()
            {
                ...
                Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 1, 0, 1}},

                Package(){"BUSARB", Package(){3, "ICBID_MASTER_BLSP_1", "ICBID_SLAVE_EBI1", 0, 6250000}},

                Package(){"TLMMGPIO", Package(){ 0, 0, 1, 0, 1, 0}},  // MOSI
                Package(){"TLMMGPIO", Package(){ 1, 0, 1, 0, 1, 0}},  // MISO
                Package(){"TLMMGPIO", Package(){ 2, 0, 1, 0, 3, 0}},  // CS
                Package(){"TLMMGPIO", Package(){ 3, 0, 1, 0, 3, 0}},  // CLK
            },
            ...
            Package()
            {
                ...
                Package(){"CLOCK", Package(){"gcc_blsp1_qup1_spi_apps_clk", 2, 0, 1}},

                Package(){"BUSARB", Package(){3, "ICBID_MASTER_BLSP_1", "ICBID_SLAVE_EBI1", 0, 0}},

                Package(){"TLMMGPIO", Package(){ 0, 0, 0, 0, 1, 0}},  // MOSI
                Package(){"TLMMGPIO", Package(){ 1, 0, 0, 0, 1, 0}},  // MISO
                Package(){"TLMMGPIO", Package(){ 2, 0, 0, 0, 3, 0}},  // CS
                Package(){"TLMMGPIO", Package(){ 3, 0, 0, 0, 1, 0}},  // CLK
            },
        },
        ...
        Package()
        {
            ...
            Package()
            {
                ...
                0x0, // D0 state
                package() {"CLOCK", package() {"gcc_blsp1_ahb_clk", 1, 100000000, 1}},
                package() {"CLOCK", package() {"gcc_blsp1_qup5_i2c_apps_clk", 8, 19200000, 4}},
                package() {"BUSARB", package() {3, "ICBID_MASTER_BLSP_1", "ICBID_SLAVE_EBI1", 153600000, 0 }},

                // Configure SDA and then SCL
                package() {"TLMMGPIO", package() {18, 1, 2, 1, 3, 0}},
                package() {"TLMMGPIO", package() {19, 1, 2, 1, 3, 0}},
            },
            Package()
            {
                "DSTATE",
            ...
            Package()
            {
                ...
                0x3, // D3 state
                package() {"CLOCK", package() {"gcc_blsp1_ahb_clk", 2, 100000000, 1}},
                package() {"CLOCK", package() {"gcc_blsp1_qup5_i2c_apps_clk", 2, 19200000, 1}},
                package() {"BUSARB", package() {3, "ICBID_MASTER_BLSP_1", "ICBID_SLAVE_EBI1", 0, 0 }},

                // Configure SCL and then SDA
                package() { "TLMMGPIO", package() {19, 0, 0, 0, 3, 0}},
                package() { "TLMMGPIO", package() {18, 0, 0, 0, 3, 0}},
            },
        },
